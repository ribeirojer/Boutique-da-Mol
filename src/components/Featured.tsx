    ...
    <section className="container mx-auto px-4 md:px-0 py-16 gap-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
      <div className="group flex justify-center items-center border border-pink-500 hover:bg-pink-500 rounded-md mb-4 p-8 gap-4">
        <svg
          ...
          height="24"
          viewBox="0 0 24 24"
          className="fill-pink-500 group-hover:fill-white h-16 w-16"
        >
      ...
      <div className="group flex justify-center items-center border border-pink-500 hover:bg-pink-500 rounded-md mb-4 p-8 gap-4">
        ...
        <h2 className="font-semibold group-hover:text-white">Frete Grátis</h2>
      </div>
      ...
      <div className="group flex justify-center items-center border border-pink-500 hover:bg-pink-500 rounded-md mb-4 p-8 gap-4">
        ...
        <h2 className="font-semibold group-hover:text-white">Suporte 24/7</h2>
      </div>
    </section>
  );
};
