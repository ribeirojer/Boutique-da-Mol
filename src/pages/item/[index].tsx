...
const Item = (props: Props) => {
  ...
  const isProductInCart = cartItems.some((item:any)=>item.id===itemToShow.id);
      ...
      <div className="container px-4 md:px-0 py-8 mx-auto">
        <div className="flex flex-col md:flex-row items-center justify-between">
          ...
          <div className="pb-8 w-full md:w-1/2">
            ...
            <h3 className="text-xl text-pink-500 font-semibold mb-4">{itemToShow?.price.toLocaleString("pt-BR", { style: "currency", currency: "BRL"})}</h3>
            {/*<p className="mb-4">{limitarDescricao(itemToShow?.description, limiteDescricao)}</p>*/}
<p className="mb-4">{itemToShow?.description.substring(0, limiteDescricao) + "..."}</p>
